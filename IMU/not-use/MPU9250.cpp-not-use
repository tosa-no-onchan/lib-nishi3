...
bool cMPU9250::begin()
{
  ...
  uint8_t whoami = imu_spi_read(MPU9250_ADDRESS, 0x75);
...
void cMPU9250::init( void )
{
  ...
  //MPU9250 Reset
	...
	imu_spi_write(MPU9250_SPIx_ADDR, MPU9250_INT_ENABLE, 1);
	delay(1);
	//MPU9250 Set Sensors
